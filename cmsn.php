...
"; break;
    ...
    case(11):$loichuc = "".$name." biết không, trái đất đang ngừng xoay 1 giây để chúc mừng sinh nhật ".$name." đó.";
    case(12):$loichuc = "Chúc mừng sinh nhật ".$name.", sang tuổi mới, thành công mới, nhiều niềm vui mới, nhiều thắng lợi mới, và nếu có thể cả người yêu mới nữa nhé.";
    case(13):$loichuc = "Hãy để những lời chúc tốt đẹp nhất của tôi luôn ở bên cạnh cuộc sống tuyệt vời của bạn. Tôi hy vọng trong năm tới bạn luôn khỏe mạnh và thuận buồm xuôi gíó trong mọi việc. Sinh nhật vui vẻ nhé !";
    case(14):$loichuc = "".$name." có thấy những ngôi sao lấp lánh trên bầu trời đang mỉm cười chúc mừng sinh nhật ".$name." không?";
    case(15):$loichuc = "Gửi đến bạn món quà này với cả tấm lòng và một lời chúc bạn sẽ hạnh phúc tràn đầy. Những điều hạnh phúc nhất luôn đến với bạn.";
    ...
    case(17): $loichuc = "Sinh nhật vui vẻ, 1 ngày lượm được cọc tiền, 1 tuần lượm được túi tiền, 1 tháng lượm được va li tiền, cả năm ôm tiền mà ngủ.";
    ...
    case(19): $loichuc="Chúc bạn luôn luôn 'vui vẻ, tươi trẻ, mạnh khoẻ, tính tình mát mẻ, cuộc đời suôn sẻ” và luôn luôn “tươi cười, yêu đời, ngời ngời sức sống'";
    case(20): $loichuc = "Chúc mọi điều ước trong ngày sinh nhật của bạn đều trở thành hiện thực, hãy thổi nến trên bánh sinh nhật để ước mơ được nhiệm màu.";
    }
